...
4. [Структура сохранения данных](#-структура-сохранения-данных) 🆕
5. [Система управления видео-реестром](#-система-управления-видео-реестром) 🆕
6. [Быстрый старт](#-быстрый-старт)
7. [Детальная настройка](#-детальная-настройка)
8. [Доменные режимы обработки](#-доменные-режимы-обработки)
9. [Формат выходных данных](#-формат-выходных-данных)
10. [API и интеграция](#-api-и-интеграция)
...
14. [Развертывание на GitHub](#-развертывание-на-github)
15. [SAG v2.0 - Структурированная генерация](#-sag-v20---структурированная-генерация)
16. [ETAP 5 - Тонкая настройка](#-etap-5---тонкая-настройка)
17. [🔍 Система экстракторов знаний (Этапы 1-5)](#-система-экстракторов-знаний-этапы-1-5) 🆕
...
│   │   ├── 🐍 test_concept_hierarchy_extractor.py
│   │   └── 🐍 run_causal_chain_tests.py
│   ├── 📁 orchestrator/        # Тесты оркестратора
│   │   ├── 🐍 test_sarsekenov_processor.py
│   │   ├── 🐍 test_knowledge_graph.py
│   │   └── 🐍 test_rag_formatter.py
│   ├── 📁 integration/         # Интеграционные тесты
│   │   └── 🐍 test_all_extractors.py
│   └── 📁 fixtures/            # Тестовые данные
│       └── 🐍 real_sarsekenov_texts.py
│
